...
| --- | --- | --- | --- |
| **Character** | `src/character/` | [character/types.md](character/types.md) species, archetypes, proportions, palette, constraints<br>[character/parts.md](character/parts.md) 25 slots, 187 parts | [character/rules.md](character/rules.md) the procedure for adding a part, separating form from motion, distribution standards |
...
| The **high five** — how often pairs land one, and whether the palms meet | `node scripts/hifive-sim.mjs` — the real pair logic over real clocks, both palms run back through FK at contact | [motion/catalog.md](motion/catalog.md) § the high five |
