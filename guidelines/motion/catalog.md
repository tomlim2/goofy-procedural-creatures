...
| ^^ happy hold | 6~16 s, **3~6 s** | **pup only** | An eye with an eyeball keeps its white and its pupil becomes the ^^ arch (a live eye swaps the pupil mesh, a static eye with a pupil under its lid is redrawn with a ^^ pupil); an eye with no ball becomes the arch itself. **A ♥ emoji makes it ^^ for 3.2 s** (every species, whatever fired the ♥) — and a dog follows it with a wag |
