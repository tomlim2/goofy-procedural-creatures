...
export const MOTION = {
  ...
  cat: {
    ...
    //   raise 기분 좋을 때(^^ 동안) 세움 — straight 빳빳이 설 확률(나머지 hook: 끝을 앞으로 굽힘) + hook 끝 떨림 quiver [amp, hz] · puff 곤두섬 배율(놀란 동안 굵기만 — 동공과 같은 0.1/3.8/0.1 봉투)
    tailSwish: { amp: [0.16, 0.3], period: [2.4, 5] }, tailFlick: [8, 20],
    tailTip: { follow: 0.06, twitch: { amp: 0.35, hz: 6, dur: 0.5 }, lash: 0, raise: { straight: 0.65, quiver: [0.08, 12] }, puff: 1 },   // 채찍질(lash)은 금지 — 고양이가 꼬리를 치는 모션은 없다
