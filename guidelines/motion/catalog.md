...
관절을 아치 세계각(`tailIdlePose` [1.15, 1.65, 2.25, 2.95] rad, 뿌리→끝: 살짝 뒤로 젖혀 오르다 끝이 머리 쪽으로 넘어가는 물음표 아치)으로 85% 섞는다
(`tailArch`). 끝 두 마디는 개체 `tailLift`로 ±0.25 — 더 말리거나 덜 말린 아치. 세움(^^)이 오면 그만큼 빠지고 잠들면 골격 그대로 접힌다.
...
| **idle 자세** arch | 상태 | 골격 그대로 (뿌리 +0.25) | **아치** — 관절 세계각 [1.15, 1.65, 2.25, 2.95] × 85% (`tailIdlePose`), 끝 두 마디 개체 tailLift ±0.25. 깨어 있고 안 서 있을 때 |
