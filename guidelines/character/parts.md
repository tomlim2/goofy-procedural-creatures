...
**pup**은 같은 값을 개 귀로 그린다 — 뿌리가 머리 위옆이고 채운 로브: flap 늘어진 로브(레퍼런스 비글) · long 턱 아래까지(바셋) ·
round 작은 동그란 귀(퍼그) · pointy 쫑긋 선 세모귀(셰퍼드) · fold 옆으로 접혀 끝만 처짐 · none 없음. 종족 bias flap 4 · long 3 · pointy 2 ·
round 1.5 · fold 1. **cat**의 pointy는 옆이 아니라 정수리에 선다.
