...
관절을 아치 세계각(`tailIdlePose` [1.85, 1.35, 0.3, −π/4] rad, 뿌리→끝: 살짝 머리 쪽으로 기울어 오르다 끝이 **머리 반대편(뒤)** 으로 넘어가 **45°로 내려오는**
...
| **idle 자세** arch | 상태 | 골격 그대로 (뿌리 +0.25) | **아치** — 관절 세계각 [1.85, 1.35, 0.3, −π/4] × 85% (`tailIdlePose`, 끝이 머리 반대편으로 넘어가 45°로 내려오는 ∩), 끝 두 마디 개체 tailLift ±0.12. 깨어 있고 안 서 있을 때 |
