...
export const MOTION = {
  ...
  cat: {
    ...
    // **머리 반대편(뒤)** 으로 넘어가 **45°로 내려온다** — 등 뒤 허공에 걸린 ∩ 아치. 끝 두 마디는 개체 tailLift(−1~1)로 ±liftBend(±7°) — 살짝만 다르게.
    // 잠·세움 땐 이 자세가 빠진다 (motion/index.js tailArch)
    tailIdlePose: { angles: [1.85, 1.35, 0.3, -Math.PI / 4], weight: 0.85, liftBend: 0.12 },
    // 고양이는 더 자주, 더 오래 잔다
