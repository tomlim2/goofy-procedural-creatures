...
export function buildEmoji(kind, noise) {
  ...
  if (kind === "heart") {
    ...
    sketch.line([[-0.026, 0.028], [0.014, 0.028], [-0.026, -0.006], [0.014, -0.006]], { color: "#2b2724", weight: 1 });
    sketch.line([[0.02, 0.06], [0.044, 0.06], [0.02, 0.04], [0.044, 0.04]], { color: "#2b2724", weight: 0.7 });
  } else if (kind === "sweat") {
