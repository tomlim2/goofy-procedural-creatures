...
none / tears (two **waves** running down below the eye, a trickle rather than a straight fall — **humans do not have them**, forbid → none; they belong to imps) / blush (a pink ellipse on the cheek) / circles (**dark circles** — the shorthand every cartoon and manga uses for the tired: a shaded half-moon under each unpatched eye, darker than the skin and pulled a little toward blue, filled with the head's goofy material like the muzzle, with one sagging line along its lower edge — the bag. On a dark skin the moon is a shade lighter instead, the face-ink rule. Two bare lines, which this was, read as wrinkles. **Every species can be tired** — the one face2 all five carry). The cheeks sit below the (startle-widened) eye.
