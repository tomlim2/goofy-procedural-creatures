...
└── headGroup                ← 원점 = 목(neckY = bodyTop). 갸웃·롤·끄덕·딥. 윤곽만 여기 직접
    ...
    └── faceGroup            ← 원점 = 머리 중심(headCy). 얼굴 돌림으로 x/y 이동 + 눌림. 이목구비 전부
        ...
        └── eyeRig ×(0~2)        ← 살아 있는 눈만
            ├── white · rim · pupil · lid · smile · shut — 눈 블록 o(뒷눈 3 · 앞눈 3.5)부터 +0 · +0.1 · +0.2 · +0.3 · +0.35 · +0.35 (shut: 감은 눈 선, 눈꺼풀 > 0.85일 때: 깜빡임 꼭대기·잠)
...
| 3.0~3.35 | 뒷눈(작은 눈) 리그 — 흰자 3 · 테 3.1 · 동공 3.2 · 눈꺼풀 3.3 · ^^/감은 선 3.35 |
| 3.5~3.85 | 앞눈(큰 눈) 리그 — 같은 순서로 +0.5. 두 눈이 겹치면 앞눈 흰자가 뒷눈 테·동공을 가린다 (교차선 없음) |
| 3.5 / 3.6 | 정지 눈 덮개 (살색) / 그 위 감은 눈 선·미소 아치 — 정지 눈에만 있어 리그와 안 부딪힌다 |
