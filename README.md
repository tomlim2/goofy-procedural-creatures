...
33 slots, 231 parts. A slot holds form only (the `material` slot a surface's goofy material — its look); pose and action are motion. Length and build (`armLength`, `legLength`, `build`) are dimension
