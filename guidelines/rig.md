...
└── headGroup                ← 원점 = 목(neckY = bodyTop). 갸웃·롤·끄덕·딥. 윤곽만 여기 직접
    ...
    │   ├── hairBackFrame ×3     ← 뒷머리(긴 머리·트윈테일·포니테일·큰 덩어리의 바깥). 머리·귀 뒤, 몸 위 (잉크 1.55)
    ...
    │   └── hairFrontFrame ×3    ← 앞머리 띠·옆머리 커튼·두건형 앞. 얼굴 위(6.55), 눈썹·입(6.6) 아래
        ...
        └── eyeRig ×(0~2)        ← 살아 있는 눈만
            ├── open{white · rim · pupil} · smile · shut — 눈 블록 o(뒷눈 3 · 앞눈 3.5)부터 +0 · +0.1 · +0.2 / +0.35 / +0.35. 감을 때 open을 **끄고** shut(감은 선, 눈꺼풀 > 0.5)이나 smile(^^·윙크)이 대신 선다 — 살색 덮개는 없다
...
| 1 | 몸 채색, 바닥선 |
| 1.5 | 몸 잉크 |
| 1.55 | 뒷머리 잉크 — 머리·귀 뒤, 몸 위 (earGroup). 실루엣 밖으로 나온 부분만 보인다 |
| 1.6 / 1.7 | 옆귀 채색 / 잉크 (사람·도깨비) — 머리 채색 뒤라 뿌리가 머리에 가린다 (earGroup) |
...
| 3.0~3.35 | 뒷눈(작은 눈) 리그 — 흰자 3 · 테 3.1 · 동공 3.2 · ^^/감은 선 3.35 (감을 땐 흰자·테·동공을 끄고 선만) |
...
| 6.55 | 앞머리 잉크 — 코·안경 위, 눈썹·입 아래 (bangsGroup) |
