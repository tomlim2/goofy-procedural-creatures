...
| --- | --- | --- | --- | --- | --- |
| **human** | 5 | 두발 | 팔레트 그대로 | forbid: 뿔 전부→none, cyclops→wide, 긴 팔(long)→medium, 귀는 none·round만(뾰족·늘어짐·접힘→round/none — 동물 귀는 사람 것이 아니다), 눈물 자국(tears)→none. 나머지는 아키타입이 결정 | 좌우·앞뒤 락킹, 팔 행위(인사·팔짱·생각…) |
