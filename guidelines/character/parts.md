...
**pup**은 같은 값을 개 귀로 그린다 — 뿌리는 **머리 윤곽 위**(얼굴 양끝: 타원 위 극각 pointy 38° · round 55° · 로브 셋은 지름 끝 86°)이고 바깥 법선을
따라 세우거나 밑으로 늘어뜨린 채운 로브: flap 늘어진 로브(레퍼런스 비글) · long 턱 아래까지(바셋) · round 작은 동그란 귀(퍼그) ·
