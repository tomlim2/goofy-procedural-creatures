...
The tail tilts with the body and drops a little further (−0.3) to lie on the floor, the cat arch drops out by 80%, and the **swish stills by 90%** — a seated tail lies and only its tip taps and flicks (a tail sweeping the floor read as a tail moving down); the wag carries on. A leg is one bone (no knee), so with a short body and long legs the hind foot passes the front one; the tilt
