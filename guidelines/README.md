...
| What the **medium** itself does | The medium page — the goofy outlines, the materials as shader balls, the shapes and the palette, drawn live by `stroke.js` from its own tables | `/how.html` ([drawing.md](drawing.md)) |
